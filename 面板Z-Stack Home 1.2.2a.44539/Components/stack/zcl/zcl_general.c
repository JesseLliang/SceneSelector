...
//###################################################################
//###################################################################
#if defined(SCENE_SELECTOR) || defined(SCENE_SELECTOR_TOUCHKEY)
	addSceneSelector_setGroupID(endPoint, group);
	return SUCCESS;
	
#elif defined(DIMMER_SWITCH) || defined(DIMMER_SWITCH_TOUCHKEY)
	addDimmerSwitch_setGroupID(endPoint, group);
	return SUCCESS;
...
//###################################################################
#if defined(SCENE_SELECTOR) || defined(SCENE_SELECTOR_TOUCHKEY)
	addSceneSelector_setSceneID(endpoint, scene);
	return SUCCESS;
